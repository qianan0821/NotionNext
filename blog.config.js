...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '浅安', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '浅安的个人网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blogs.qianan.fun', // 网站地址
